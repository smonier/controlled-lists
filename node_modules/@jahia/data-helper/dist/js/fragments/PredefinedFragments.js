...
var canLockUnlock = {
  applyFor: 'node',
  gql: (0, _graphqlTag["default"])(_templateObject13 || (_templateObject13 = (0, _taggedTemplateLiteral2["default"])(["fragment CanLockUnlockInfo on JCRNode {\n        lockInfo {\n            canLock,\n            canUnlock,\n        }\n    }"])))
};
exports.canLockUnlock = canLockUnlock;
var subNodesCount = {
  variables: {
    subNodesCountTypes: '[String!]!'
  },
  applyFor: 'node',
  gql: (0, _graphqlTag["default"])(_templateObject14 || (_templateObject14 = (0, _taggedTemplateLiteral2["default"])(["fragment SubNodesCount on JCRNode {\n        subNodes: children(typesFilter: {types: $subNodesCountTypes, multi: ANY}) {\n            pageInfo {\n                totalCount\n            }\n        }\n    }"])))
};
exports.subNodesCount = subNodesCount;
var childNodeTypes = {
  applyFor: 'node',
  gql: (0, _graphqlTag["default"])(_templateObject15 || (_templateObject15 = (0, _taggedTemplateLiteral2["default"])(["fragment AllowedChildNodeType on JCRNode {\n        allowedChildNodeTypes(includeSubTypes: false) {\n            name\n        }\n    }"])))
};
exports.childNodeTypes = childNodeTypes;
var contentRestrictions = {
  applyFor: 'node',
  gql: (0, _graphqlTag["default"])(_templateObject16 || (_templateObject16 = (0, _taggedTemplateLiteral2["default"])(["fragment ContentRestriction on JCRNode {\n        contributeTypes: property(name: \"j:contributeTypes\") {\n            values\n        }\n        ancestors(fieldFilter: {filters: {evaluation: NOT_EMPTY, fieldName: \"contributeTypes\"}}) {\n            ...NodeCacheRequiredFields\n            contributeTypes : property(name: \"j:contributeTypes\") {\n                values\n            }\n        }\n    }"])))
};
exports.contentRestrictions = contentRestrictions;
var siteHomePage = {
  applyFor: 'node',
  gql: (0, _graphqlTag["default"])(_templateObject17 || (_templateObject17 = (0, _taggedTemplateLiteral2["default"])(["fragment NodeSiteHomePage on JCRNode {\n        children(typesFilter:{types:[\"jnt:page\"]}, propertiesFilter:{filters:[{property:\"j:isHomePage\", value:\"true\" }]}) {\n            nodes {\n                path\n                ...NodeCacheRequiredFields\n            }\n        }\n    }"])))
};
exports.siteHomePage = siteHomePage;
var nodeCacheRequiredFields = {
  applyFor: 'node',
  gql: (0, _graphqlTag["default"])(_templateObject18 || (_templateObject18 = (0, _taggedTemplateLiteral2["default"])(["fragment NodeCacheRequiredFields on JCRNode {\n        uuid\n        workspace\n        path\n    }"])))
};
...
var nodeTypeDisplayName = {
  ...
  applyFor: 'nodeType',
  gql: (0, _graphqlTag["default"])(_templateObject19 || (_templateObject19 = (0, _taggedTemplateLiteral2["default"])(["fragment NodeTypeDisplayName on JCRNodeType {\n        displayName(language:$language)\n    }"])))
};
...
var nodeTypeSubTypes = {
  ...
  applyFor: 'nodeType',
  gql: (0, _graphqlTag["default"])(_templateObject20 || (_templateObject20 = (0, _taggedTemplateLiteral2["default"])(["fragment NodeTypeSubTypes on JCRNodeType {\n        subTypes {\n            nodes {\n                name\n                displayName(language:$language)\n                abstract\n                mixin\n            }\n        }\n    }"])))
};
exports.nodeTypeSubTypes = nodeTypeSubTypes;
var mimeTypes = {
  applyFor: 'node',
  gql: (0, _graphqlTag["default"])(_templateObject21 || (_templateObject21 = (0, _taggedTemplateLiteral2["default"])(["fragment NodeInfoResourceNode on JCRNode {\n        resourceChildren: children(names: [\"jcr:content\"]) {\n            nodes {\n                ...NodeCacheRequiredFields\n                mimeType: property(name: \"jcr:mimeType\") {\n                    value\n                }\n            }\n        }\n    }"])))
};
exports.mimeTypes = mimeTypes;
var isExternal = {
  applyFor: 'node',
  gql: (0, _graphqlTag["default"])(_templateObject22 || (_templateObject22 = (0, _taggedTemplateLiteral2["default"])(["fragment External on JCRNode {\n        isExternal\n    }"])))
};
