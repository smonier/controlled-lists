...
export var canLockUnlock = {
  applyFor: 'node',
  gql: gql(_templateObject13 || (_templateObject13 = _taggedTemplateLiteral(["fragment CanLockUnlockInfo on JCRNode {\n        lockInfo {\n            canLock,\n            canUnlock,\n        }\n    }"])))
};
export var subNodesCount = {
  ...
  applyFor: 'node',
  gql: gql(_templateObject14 || (_templateObject14 = _taggedTemplateLiteral(["fragment SubNodesCount on JCRNode {\n        subNodes: children(typesFilter: {types: $subNodesCountTypes, multi: ANY}) {\n            pageInfo {\n                totalCount\n            }\n        }\n    }"])))
};
export var childNodeTypes = {
  applyFor: 'node',
  gql: gql(_templateObject15 || (_templateObject15 = _taggedTemplateLiteral(["fragment AllowedChildNodeType on JCRNode {\n        allowedChildNodeTypes(includeSubTypes: false) {\n            name\n        }\n    }"])))
};
export var contentRestrictions = {
  applyFor: 'node',
  gql: gql(_templateObject16 || (_templateObject16 = _taggedTemplateLiteral(["fragment ContentRestriction on JCRNode {\n        contributeTypes: property(name: \"j:contributeTypes\") {\n            values\n        }\n        ancestors(fieldFilter: {filters: {evaluation: NOT_EMPTY, fieldName: \"contributeTypes\"}}) {\n            ...NodeCacheRequiredFields\n            contributeTypes : property(name: \"j:contributeTypes\") {\n                values\n            }\n        }\n    }"])))
};
export var siteHomePage = {
  applyFor: 'node',
  gql: gql(_templateObject17 || (_templateObject17 = _taggedTemplateLiteral(["fragment NodeSiteHomePage on JCRNode {\n        children(typesFilter:{types:[\"jnt:page\"]}, propertiesFilter:{filters:[{property:\"j:isHomePage\", value:\"true\" }]}) {\n            nodes {\n                path\n                ...NodeCacheRequiredFields\n            }\n        }\n    }"])))
};
export var nodeCacheRequiredFields = {
  applyFor: 'node',
  gql: gql(_templateObject18 || (_templateObject18 = _taggedTemplateLiteral(["fragment NodeCacheRequiredFields on JCRNode {\n        uuid\n        workspace\n        path\n    }"])))
};
export var nodeTypeDisplayName = {
  ...
  applyFor: 'nodeType',
  gql: gql(_templateObject19 || (_templateObject19 = _taggedTemplateLiteral(["fragment NodeTypeDisplayName on JCRNodeType {\n        displayName(language:$language)\n    }"])))
};
export var nodeTypeSubTypes = {
  ...
  applyFor: 'nodeType',
  gql: gql(_templateObject20 || (_templateObject20 = _taggedTemplateLiteral(["fragment NodeTypeSubTypes on JCRNodeType {\n        subTypes {\n            nodes {\n                name\n                displayName(language:$language)\n                abstract\n                mixin\n            }\n        }\n    }"])))
};
export var mimeTypes = {
  applyFor: 'node',
  gql: gql(_templateObject21 || (_templateObject21 = _taggedTemplateLiteral(["fragment NodeInfoResourceNode on JCRNode {\n        resourceChildren: children(names: [\"jcr:content\"]) {\n            nodes {\n                ...NodeCacheRequiredFields\n                mimeType: property(name: \"jcr:mimeType\") {\n                    value\n                }\n            }\n        }\n    }"])))
};
export var isExternal = {
  applyFor: 'node',
  gql: gql(_templateObject22 || (_templateObject22 = _taggedTemplateLiteral(["fragment External on JCRNode {\n        isExternal\n    }"])))
};
